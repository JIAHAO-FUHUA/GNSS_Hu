...
class GnssSsrCodeBiases {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.biases.forEach((val) => {
      bufferOffset = GnssSsrCodeBias.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GnssSsrCodeBiases(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.biases[i] = GnssSsrCodeBias.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.biases.forEach((val) => {
      length += GnssSsrCodeBias.getMessageSize(val);
    });
    return length + 4;
  }
  ...
  static datatype() {
    ...
    return 'gnss_comm/GnssSsrCodeBiases';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '05586c0a1dbc34d82fa205883493e7e2';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GnssSsrCodeBiases(null);
    ...
    if (msg.biases !== undefined) {
      ...
      for (let i = 0; i < resolved.biases.length; ++i) {
        resolved.biases[i] = GnssSsrCodeBias.Resolve(msg.biases[i]);
      }
    }
    else {
      resolved.biases = []
...
module.exports = GnssSsrCodeBiases;
