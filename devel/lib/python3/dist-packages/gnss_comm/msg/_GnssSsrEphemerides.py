...
"""autogenerated by genpy from gnss_comm/GnssSsrEphemerides.msg. Do not edit."""
import codecs
import sys
...
class GnssSsrEphemerides(genpy.Message):
  _md5sum = "e4d2051d76baaed52944bc5181382d27"
  _type = "gnss_comm/GnssSsrEphemerides"
...
"""
  __slots__ = ['header','corrections']
  _slot_types = ['std_msgs/Header','gnss_comm/GnssSsrEphemeris[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GnssSsrEphemerides, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.corrections)
      buff.write(_struct_I.pack(length))
      for val1 in self.corrections:
        _x = val1.prn
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(struct.Struct(pattern).pack(*val1.deph))
        length = len(val1.ddeph)
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(struct.Struct(pattern).pack(*val1.ddeph))
        length = len(val1.dclk)
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(struct.Struct(pattern).pack(*val1.dclk))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = gnss_comm.msg.GnssSsrEphemeris()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        val1.deph = s.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        val1.ddeph = s.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        val1.dclk = s.unpack(str[start:end])
        self.corrections.append(val1)
      return self
