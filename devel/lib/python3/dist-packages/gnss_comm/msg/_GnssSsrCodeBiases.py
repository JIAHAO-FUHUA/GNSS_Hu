...
"""autogenerated by genpy from gnss_comm/GnssSsrCodeBiases.msg. Do not edit."""
import codecs
import sys
...
class GnssSsrCodeBiases(genpy.Message):
  _md5sum = "05586c0a1dbc34d82fa205883493e7e2"
  _type = "gnss_comm/GnssSsrCodeBiases"
...
"""
  ...
  _slot_types = ['std_msgs/Header','gnss_comm/GnssSsrCodeBias[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GnssSsrCodeBiases, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = gnss_comm.msg.GnssSsrCodeBias()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
